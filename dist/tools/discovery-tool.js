...
export const discoveryToolRouter = {
    ...
    async call(args) {
        ...
        switch (action) {
            ...
            case "ranking":
                return normalizeVideoList(await getRanking({ rid: optionalNumber(TOOL_NAME, args, "rid"), type: optionalString(args.type) }), "ranking", { limit });
            case "weekly":
...
function requireDiscoveryAction(args) {
