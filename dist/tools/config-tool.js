...
import { assertAllowedArgs, optionalString, requireString } from "./common.js";
const TOOL_NAME = "bilibili_config";
const CONFIG_ACTIONS = ["setup", "status"];
export const configToolRouter = {
    definition: {
        name: TOOL_NAME,
...
function requireConfigAction(args) {
