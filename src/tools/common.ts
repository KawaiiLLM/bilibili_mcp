...
export function assertAllowedArgs(tool: string, args: Record<string, unknown>, allowed: string[]): void {
...
export function requireString(tool: string, args: Record<string, unknown>, field: string): string {
...
export function optionalNumber(tool: string, args: Record<string, unknown>, field: string): number | undefined {
  const value = args[field];
...
export function positiveInteger(value: number | undefined, fallback: number, field: string, tool: string): number {
...
export function optionalNumberArray(value: unknown, field: string, tool: string): number[] | undefined {
  if (value === undefined) return undefined;
